...
var data = [
    {
        ...
        short_description: "Our most popular alteration for men, for anything from jeans to suit alterations",
        category: 'formal',
        description: "Our most popular alteration for men, for anything from jeans to suit alterations. We request that you safety pin the trousers with a single pin in one leg to the length that you'd like them shortened to, or include a clearly marked pair that fit perfectly, to be copied. Alternatively, you can let us know in the notes (when adding to cart) how much you'd like taken off in cms or inches.",
        alteration_price : 50,
        is_available : true,
        ...
        short_description: "Our most popular alteration for women, for anything from jeans to suit alterations",
        category: 'informal',
        ...
        short_description: "Our most popular alteration for kids, for anything from uniform to casula wear alterations",
        category: 'formal',
